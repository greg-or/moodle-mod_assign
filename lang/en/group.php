...
$string['selectfromgroup'] = 'Select members from existing group';
$string['selectfromgroup_help'] = 'Choose a group to restrict the members used in the autocreate groups process';
$string['selectfromgrouping'] = 'Select members from existing grouping';
$string['selectfromgrouping_help'] = 'Choose a grouping to restrict the members used in the autocreate groups process';
